...
\newcommand{\TypPrace}{Semestrální práce předmětu IoT}
...
\appendix
\section{Přílohy}
\subsection{Zdrojový kód ESP32}

\lstinputlisting[language=C++, caption={Hlavní program (main.cpp)}]{../src/main.cpp}

\lstinputlisting[language=C++, caption={Pomocný soubor pro práci se soubory (settings\_manager.cpp)}]{../src/settings_manager.cpp}
